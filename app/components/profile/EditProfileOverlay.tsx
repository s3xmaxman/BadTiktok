...
export default function EditProfileOverlay() {
    ...
    const cropAndUpdateImage = async() => {
        ...
        try {
            // 選択画像やトリミング情報がない場合は処理終了  
            if(!file) return alert('You have not selected an image')
            if(!cropper) return alert('You have not cropped the image')
            setIsUpdating(true)
    ...
    return (
        <>
           <div
                ...
                className="fixed flex justify-center pt-14 md:pt-[105px] z-50 
                top-0 left-0 w-full h-full bg-black bg-opacity-50 overflow-auto" 
           >
             <div
             ...
             >
                ...
                {!uploadedImage ? ( 
                    <div>
                        ...
                        <div
                            id="UserNameSection"
                            className="flex flex-col border-b sm:h-[118px] mt-1.5 px-1.5 py-2 w-full"
                        >
                           <h3 className="font-semibold text-[15px] sm:mb-0 mb-1 text-gray-700 sm:w-[160px] sm:text-left text-center">
                                Name
                           </h3>
